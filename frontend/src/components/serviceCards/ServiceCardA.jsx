      ...
      <div className="relative z-10 px-6 pt-6" dir="rtl">
        <div className="flex items-center justify-between mb-3">
          ...
          <div
            ...
            style={{
              background:
                "linear-gradient(90deg, transparent 0%, rgba(77, 208, 225, 0.3) 15%, #4dd0e1 25%, #80deea 40%, #b2ebf2 50%, #80deea 60%, #4dd0e1 75%, rgba(77, 208, 225, 0.3) 85%, transparent 100%)",
              boxShadow: `
                0 0 14px rgba(178, 235, 242, 0.9),
                0 1px 3px rgba(77, 208, 225, 0.6),
                0 -1px 3px rgba(224, 247, 250, 0.7)
              `,
              height: "1.5px",
            }}
          />
        ...
        <div className="flex items-center gap-0 mt-6" style={{ alignItems: "center" }}>
          ...
          <h3
            ...
            style={{
              background: "linear-gradient(135deg, #1A1308 0%, #3F2D17 35%, #5C4426 65%, #3F2D17 100%)",
              WebkitBackgroundClip: "text",
              WebkitTextFillColor: "transparent",
              backgroundClip: "text",
              textShadow: "none",
              filter: "drop-shadow(0 1px 1px rgba(255,255,255,0.3)) drop-shadow(0 2px 3px rgba(0,0,0,0.15))",
              lineHeight: "32px",
              display: "flex",
              alignItems: "center",
            }}
        ...
        >
          ...
          >
            ...
            <div 
              ...
              style={{
                background: "linear-gradient(90deg, #4dd0e1 0%, #80deea 20%, #b2ebf2 50%, #80deea 80%, #4dd0e1 100%)",
                boxShadow: "0 0 12px rgba(178, 235, 242, 0.9), 0 2px 4px rgba(77, 208, 225, 0.6), 0 -1px 3px rgba(224, 247, 250, 0.7)",
                minHeight: "2px",
                flexShrink: 0
              }}
            />
